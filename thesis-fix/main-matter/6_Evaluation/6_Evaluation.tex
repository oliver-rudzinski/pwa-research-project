...
\input{main-matter/6_Evaluation/6-2_Installation}

\subsection{Speicherzugriff} \label{sec:6-speicherzugriff}
\input{main-matter/6_Evaluation/6-3_Speicherzugriff}

\subsection{Speicherbedarf} \label{sec:6-speicherbedarf}
\input{main-matter/6_Evaluation/6-4_Speicherbedarf}

\subsection{Aktualisierbarkeit} \label{sec:6-aktualisierbarkeit}
\input{main-matter/6_Evaluation/6-5_Aktualisierbarkeit}
...
\input{main-matter/6_Evaluation/6-7_Bibliotheken}

\subsection{Umsetzbarkeit} \label{sec:6-umsetzung}
\input{main-matter/6_Evaluation/6-8_Umsetzung}
...
\input{main-matter/6_Evaluation/6-10_Vorausgesetzte_Entwicklungserfahrung}
