...
\input{main-matter/4_Architektur/4-1_Anforderungsdefinition}

\section{Speicherung der Daten} \label{sec:4-speicherung-daten}
\input{main-matter/4_Architektur/4-2_Speicherung_der_Daten}

\section{Benutzeroberfläche (\acs{ui})} \label{sec:4-3_ui}
\input{main-matter/4_Architektur/4-3_Benutzeroberflaeche_(UI)}

\section{Nutzungszyklus} \label{sec:3-nutzungszyklus}
\input{main-matter/4_Architektur/4-4_Nutzungszyklus}