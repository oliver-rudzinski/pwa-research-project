...
\begin{figure}[h!]
	...
	\caption[Interface Builder in Xcode]{Interface Builder in Xcode \cite{AppleIB}}
	\label{fig:xcode-ib}
\end{figure}
...
\begin{figure}[h!]
	...
	\caption[Zusammenspiel des \acs{mvc}-Musters]{Zusammenspiel des \acs{mvc}-Musters \cite{RayMVC}}
\end{figure}
