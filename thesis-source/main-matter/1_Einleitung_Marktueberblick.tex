...
Mehrere Google Fallstudien beschreiben einen positiven Effekt von \ac{pwa}s auf Kunden \cite{GoogleShowCases}. Diese Arbeit beschreibt nach ausführlicher Betrachtung der beiden Technologien \ac{pwa} und native App die Vor- und Nachteile dieser Methoden, um ein grobes Bild der zukünftigen Entwicklung von Apps zu umreißen.
